    ...
    public Box processIncidentEdges(XYNodeSortedList statusStructT, Horizontal horizontalStruct, XYNode n) {
            ...
            if(edge1Y != null && edge2X != null) {
                ...
                if(edge2Y) {
                    ...
                    if(n.getY() == edge1Y1 && n.getY() == edge2X.getNext().getY()) {
                        polygon.modify(edge1Y.getPrev().getX(), edge1Y.getPrev().getY(), edge2X.getNext().getNext().getX(), edge2X.getNext().getNext().getY());
                    } else if(n.getY() == edge1Y1 && n.getY() > edge2X.getNext().getY()) {
                        polygon.modify(edge1Y.getPrev().getX(), edge1Y.getPrev().getY(), edge2X1, n.getY(), edge2X.getNext().getX(), edge2X.getNext().getY());
                    } else if(n.getY() > edge1Y1 && n.getY() == edge2X.getNext().getY()) {
                        polygon.modify(isNewRect, edge1Y1, isNewRect, n.getY(), edge2X.getNext().getNext().getX(), edge2X.getNext().getNext().getY());
                    } else if(n.getY() > edge1Y1 && n.getY() > edge2X.getNext().getY()) {
                        polygon.modify(isNewRect, edge1Y1, isNewRect, n.getY(), edge2X1, n.getY(), edge2X.getNext().getX(), edge2X.getNext().getY());
                    }
        ...
        if(n.getX() == n.getPrev().getX() && n.getY() < n.getPrev().getY()) {
            ...
            if(rightNeighbor1 != null) {
                ...
                isNewRect1 = horizontalStruct.isConnected(rightNeighbor1.getNext().getX(), rightNeighbor1.getNext().getY(), n.getPrev().getX(), n.getPrev().getY());
                if(isNewRect1) {
                    //Box box = new Box();
                    box = new Box();
